...
describe("TicTacToe Component", () => {
  ...
  it("starts the game after entering a player name", () => {
    ...
    expect(screen.getByText(/Hello, Player1! It's your turn/i)).toBeInTheDocument();
  });
  ...
  describe("Gameplay", () => {
    ...
    it("allows the player to make a move", () => {
      ...
      const gameCell = cells.find(cell => 
    ...
    it("shows a draw message when the game ends in a draw", async () => {
      const cells = screen.getAllByRole("button").filter(cell => 
        cell.closest('[data-testid="game-board"]')
      );
