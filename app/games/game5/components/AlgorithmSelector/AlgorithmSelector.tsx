    ...
    <div className="mb-6 w-full max-w-md mx-auto">
      <div className="relative">
        ...
        <div className="mt-2 flex justify-between text-xs text-gray-500">
          <span className={`flex items-center ${algorithm === 'backtracking' ? 'text-indigo-600 font-medium' : ''}`}>
            <FaChessKnight className="mr-1" /> Exhaustive search
          </span>
          <span className={`flex items-center ${algorithm === 'warnsdorff' ? 'text-indigo-600 font-medium' : ''}`}>
